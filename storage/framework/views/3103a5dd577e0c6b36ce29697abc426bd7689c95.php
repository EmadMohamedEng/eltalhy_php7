...
<html>
    ...
    <body style="background-image: url(<?php echo e(url('img/black-pattern.png')); ?>)">
        ...
        <ul class="list-unstyled">
                    <li><a class="fb" target="_blank" href="<?php echo e($settings['facebook_link']); ?>"><i class="fa fa-facebook"></i></a></li>
                    <li><a class="tw" target="_blank" href="<?php echo e($settings['twitter_link']); ?>"><i class="fa fa-twitter"></i></a></li>
                    <li><a class="gp" target="_blank" href="<?php echo e($settings['youtube_link']); ?>"><i class="fa fa-youtube"></i></a></li>
                    <li><a class="ns" target="_blank" href="<?php echo e($settings['instagram_link']); ?>"><i class="fa fa-instagram"></i></a></li>
                    <li><a class="tl" target="_blank" href="<?php echo e($settings['telegram_link']); ?>"><i class="fa fa-telegram"></i></a></li>
                    <li><a class="sc" target="_blank" href="<?php echo e($settings['soundcloud_link']); ?>"><i class="fa fa-soundcloud"></i></a></li>
        </ul>
      </div>
