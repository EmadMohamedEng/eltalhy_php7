        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-content">
                    <form action="<?php echo e(url('book')); ?>" method="post" class="form-horizontal form-bordered form-row-stripped"
                        ...
                        <div id="section">
                            <div class="form-group<?php echo e($errors->has('section') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-sm-2 col-lg-3 controls">
                                    <input type="text" placeholder="section" class="form-control" name="sections[]"
                                        required>
                                </div>
                                <div class="col-sm-2 col-lg-3 controls">
                                    <input type="number" placeholder="page number" class="form-control" name="numbers[]"
                                        required>
                                </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eltalhy_php7\resources\views/book/create.blade.php ENDPATH**/ ?>