<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-title">
                    <h3><i class="fa fa-bars"></i>Uploader</h3>
                    <div class="box-tool">
                        ...
                        <div class="col-md-12">
                            <fieldset><legend> Items </legend>
                                ...
                                <div class="form-group  " >
                                    <label for="Artist" class=" control-label col-md-5 text-left"> Item <span class="asterix"> * </span></label>
                                    <div class="col-md-4">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eltalhy_php7\resources\views/dashboard/multi_uploader.blade.php ENDPATH**/ ?>