...
<div id="main-content">
    ...
    <div class="page-title">
        <div>
            <h1><i class="fa fa-file-o"></i>Abouts</h1>
        </div>
    </div>
    <!-- END Page Title -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-title">
                    <h3><i class="fa fa-bars"></i>About</h3>
                    <div class="box-tool">
                ...
                <div class="box-content">
                    <form action="{{url('about/'.$about->id.'/update')}}" method="post" class="form-horizontal form-bordered form-row-stripped" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                         <div class="form-group">
                            <label for="textfield5" class="col-sm-3 col-lg-2 control-label">Title</label>
                            <div class="col-sm-9 col-lg-10 controls">
                                <input type="text" name="title" id="title" value="{{$about->title}}" placeholder="title" class="form-control" required readonly >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-10 controls">
                                ...
                                <textarea name="description" class="form-control ckeditor" required>{{$about->description}}</textarea>
                            </div>
                        </div>
