        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-content">
                    <form action="{{url('about')}}" method="post" class="form-horizontal form-bordered form-row-stripped" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-10 controls">
                               <textarea class="form-control col-md-12 ckeditor" name="description" rows="6"></textarea>
                            </div>
                        </div>
