...
<head>
  ...
  <script src="book_plugin/booklet/jquery.easing.1.3.js" type="text/javascript"></script>
  <script src="book_plugin/booklet/jquery.booklet.1.1.0.min.js" type="text/javascript"></script>

  <link href="book_plugin/booklet/jquery.booklet.1.1.0.css" type="text/css" rel="stylesheet" media="screen" />
  <link rel="stylesheet" href="book_plugin/css/style.css" type="text/css" media="screen" />

  <script src="book_plugin/cufon/cufon-yui.js" type="text/javascript"></script>
  <script src="book_plugin/cufon/ChunkFive_400.font.js" type="text/javascript"></script>
  <script src="book_plugin/cufon/Note_this_400.font.js" type="text/javascript"></script>
...
<body>
  ...
  <div class="book_wrapper">
    ...
    <div id="mybook" style="display:none;">
      <div class="b-load">
        <div>
          <img src="book_plugin/images/1.jpg" alt="" />
        ...
        <div>
          <img src="book_plugin/images/2.jpg" alt="" />
          <h1>Slider Gallery</h1>
          <p>This tutorial is about creating a creative gallery with a
            slider for the thumbnails. The idea is to have an expanding
            thumbnails area which opens once an album is chosen.
        ...
        <div>
          <img src="book_plugin/images/3.jpg" alt="" />
          <h1>Slider Gallery</h1>
          <p>This tutorial is about creating a creative gallery with a
            slider for the thumbnails. The idea is to have an expanding
            thumbnails area which opens once an album is chosen.
        ...
        <div>
          <img src="book_plugin/images/4.jpg" alt="" />
          <h1>Slider Gallery</h1>
          <p>This tutorial is about creating a creative gallery with a
            slider for the thumbnails. The idea is to have an expanding
            thumbnails area which opens once an album is chosen.
        ...
        <div>
          <img src="book_plugin/images/5.jpg" alt="" />
          <h1>Slider Gallery</h1>
          <p>This tutorial is about creating a creative gallery with a
            slider for the thumbnails. The idea is to have an expanding
            thumbnails area which opens once an album is chosen.
