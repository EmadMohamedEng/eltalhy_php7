...
<head>
  ...
  <style>
    ...
    .sj-book .p74 {
      ...
      background-image:url({{url($cover->photo_path)
    }
    }
  ...
  <section class="single-book-page pages-body">
    <div class="container">
      <div id="canvas" class="hidden-sm hidden-xs">
        <div id="book-zoom">
          ...
          <div class="hard fixed back-side p73">
            <div class="depth"></div>
          </div>
    ...
    <script type="text/javascript">
      ...
      yepnope({
        ...
        yep: ['{{url('
          books / js / turn.min.js ')}}'
        ],
        nope: ['{{url('
          books / js / turn.html4.min.js ')}}', '{{url('
          books / css / jquery.ui.html4.css ')}}', '{{url('
          books / css / books - html4.css ')}}'
        ],
        both: ['{{url('
          books / css / jquery.ui.css ')}}', '{{url('
          books / css / books.css ')}}'
        ],
        complete: loadApp
      });
      ...
      function loadPage(page) {
        console.log();
        $.ajax({
          url: "{{url('book/'.$book->id.'/loadpage')}}/" + page
        }).
