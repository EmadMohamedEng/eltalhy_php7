...
<div id="main-content">
    ...
    <div class="page-title">
        <div>
            <h1><i class="fa fa-file-o"></i>Jobs</h1>
        </div>
    </div>
    <!-- END Page Title -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-title">
                    <h3><i class="fa fa-bars"></i>Job</h3>
                    <div class="box-tool">
                ...
                <div class="box-content">
                    <form action="{{url('job/'.$job->id.'/update')}}" method="post" class="form-horizontal form-bordered form-row-stripped">
              			{!! csrf_field() !!}
                         <div class="form-group">
                            <label for="textfield5" class="col-sm-3 col-lg-2 control-label">Name</label>
                            <div class="col-sm-9 col-lg-10 controls">
                                <input type="text" name="name" id="name" value="{{$job->name}}" placeholder="name" class="form-control" required>
                            </div>
                        </div>
