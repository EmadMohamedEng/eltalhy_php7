...
<div id="main-content">
    ...
    <div class="page-title">
        <div>
            <h1><i class="fa fa-file-o"></i>Sliders</h1>
        </div>
    </div>
    <!-- END Page Title -->
        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-content">
                    <form action="{{url('slider/'.$slider->id.'/update')}}" method="post" class="form-horizontal form-bordered form-row-stripped" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                         <div class="form-group">
                            <label for="textfield5" class="col-sm-3 col-lg-2 control-label">Title</label>
                            <div class="col-sm-9 col-lg-10 controls">
                                <input type="text" name="title" id="title" value="{{$slider->title}}" placeholder="title" class="form-control" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="textfield5" class="col-sm-3 col-lg-2 control-label">Link</label>
                            <div class="col-sm-9 col-lg-10 controls">
                                <input type="text" name="link" id="link" value="{{$slider->link}}" placeholder="link" class="form-control" required>
                            </div>
                        </div>
                          ...
                          <div class="col-sm-9 col-lg-10 controls">
                             <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px;">
                                   <img src="{{url($slider->photo_path)}}" alt="" />
                                </div>
