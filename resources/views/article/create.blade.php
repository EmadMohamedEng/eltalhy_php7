...
<div id="main-content">
    ...
    <div class="page-title">
        <div>
            <h1><i class="fa fa-file-o"></i>Create Article</h1>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-title">
                    <h3><i class="fa fa-bars"></i>Create Article</h3>
                    <div class="box-tool">
                ...
                <div class="box-content">
                    <form action="{{url('article')}}" method="post" class="form-horizontal form-bordered form-row-stripped" enctype="multipart/form-data">
              			{!! csrf_field() !!}
                        ...
                        <div class="form-group">
                            <label for="textfield5" class="col-sm-3 col-lg-2 control-label">Brief Summery</label>
                            <div class="col-sm-9 col-lg-10 controls">
                              <textarea name="short_summery" maxlength="165" class="form-control"></textarea>
