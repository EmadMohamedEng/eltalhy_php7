        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-content">
                    <form action="{{url('album/'.$album->id.'/update')}}" method="post" class="form-horizontal form-bordered form-row-stripped" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                         <div class="form-group">
                            <label for="textfield5" class="col-sm-3 col-lg-2 control-label">Title</label>
                            <div class="col-sm-9 col-lg-10 controls">
                                <input type="text" name="name" id="name" value="{{$album->name}}" placeholder="title" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-10 controls">
                                ...
                                <textarea name="description" class="form-control" required>{{$album->description}}</textarea>
                            </div>
                        </div>
