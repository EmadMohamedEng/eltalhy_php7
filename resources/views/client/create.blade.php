...
<div id="main-content">
    ...
    <div class="page-title">
        <div>
            <h1><i class="fa fa-file-o"></i>Create Client</h1>
            <h4>Create Client</h4>
        </div>
    </div>
    <!-- END Page Title -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-title">
                    <h3><i class="fa fa-bars"></i>Create Client</h3>
                    <div class="box-tool">
                ...
                <div class="box-content">
                    <form action="{{url('client')}}" method="post" class="form-horizontal form-bordered form-row-stripped" enctype="multipart/form-data">
              			{!! csrf_field() !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-10 controls">
                                <input type="text" name="website_link" id="website_link" placeholder="Website Link" class="form-control" required>
                            </div>
                        </div>
                          ...
                          <div class="col-sm-9 col-lg-10 controls">
                             <div class="fileupload fileupload-new" data-provides="fileupload">
                                ...
                                <div>
                                   ...
                                   <input type="file" class="file-input" name="picture" required /></span>
