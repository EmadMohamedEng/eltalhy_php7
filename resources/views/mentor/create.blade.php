...
<div id="main-content">
    ...
    <div class="page-title">
        <div>
            <h1><i class="fa fa-file-o"></i>mentors</h1>
        </div>
    </div>
    <!-- END Page Title -->
        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-content">
                    <form action="{{url('mentor')}}" method="post" class="form-horizontal form-bordered form-row-stripped" enctype="multipart/form-data">
                        {!! csrf_field() !!}
