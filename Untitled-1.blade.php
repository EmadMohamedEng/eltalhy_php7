                    ...
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default">
                            <div class="panel-heading hvr-bounce-to-left" id="headingOne">
                                <h4 class="panel-title"><a aria-expanded="false" class="collapsed"
                                        data-parent="#accordion" data-toggle="collapse" href="#collapseOne">النســـــب
                                    </a></h4>
                            </div>
                            ...
                            <div aria-expanded="false" class="panel-collapse collapse" id="collapseOne"
                                ...
                                <div class="panel-body">
                                    <p>هو السيّد: &nbsp;أحمد ابن فوزي بن خليفة الطلحي يرجع نسبه للإمام الحسن المثنى بن
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading hvr-bounce-to-left" id="headingTwo">
                                <h4 class="panel-title"><a aria-expanded="false" class="collapsed"
                                        data-parent="#accordion" data-toggle="collapse" href="#collapseTwo">المولد </a>
                                </h4>
                            </div>
                            ...
                            <div aria-expanded="false" class="panel-collapse collapse" id="collapseTwo"
                                style="height: 0px;">
                                <div class="panel-body">
                                    <p>ولد من والديــن شريفين من ذرية الإمام الحســن بن علي بن أبي طالب <span
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading hvr-bounce-to-left" id="headingThree">
                                <h4 class="panel-title"><a aria-expanded="false" class="collapsed"
                                        data-parent="#accordion" data-toggle="collapse" href="#collapseThree">تكوينه
                                    </a></h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading hvr-bounce-to-left" id="headingFive">
                                <h4 class="panel-title"><a aria-expanded="false" class="collapsed"
                                        data-parent="#accordion" data-toggle="collapse" href="#collapseFive">المسيرة
                                        العلمية الدعوية </a></h4>
                            </div>

                            <div aria-expanded="false" class="panel-collapse collapse" id="collapseFive">
                                <div class="panel-body">
                                    <p>عيّن إمام وخطيب ومحفظ بجامع سيّدنا الزبير بن العوام &ndash; البيضاء - &nbsp;ليبيا
                                        .</p>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading hvr-bounce-to-left" id="headingSeven">
                                <h4 class="panel-title"><a aria-expanded="false" class="collapsed"
                                        data-parent="#accordion" data-toggle="collapse" href="#collapseSeven">الإنجازات
                                    </a></h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading hvr-bounce-to-left" id="headingEight">
                                <h4 class="panel-title"><a aria-expanded="false" class="collapsed"
                                        data-parent="#accordion" data-toggle="collapse" href="#collapseEight">الأنشطة والرحلات </a></h4>
                            </div>

                            <div aria-expanded="false" class="panel-collapse collapse" id="collapseEight">
                                <div class="panel-body">
                                    <p>أقام دروساً ومجالس للتعليم والإرشاد والتوجيه والتوعية والدعوة إلى الله في بلدان
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" id="headingNine">
                                <h4 class="panel-title"><a aria-expanded="false" class="collapsed"
                                        data-parent="#accordion" data-toggle="collapse" href="#collapseNine">المحاضرات الخارجية </a></h4>
                            </div>

                            <div aria-expanded="false" class="panel-collapse collapse" id="collapseNine"
                                style="height: 0px;">
                                <div class="panel-body">
                                    <p>ألقى محاضرات ذات بال تتناول قضايا&nbsp; تهم المجتمع الإنساني في أنحاء العالم من
                                        أهمها</p>
                                    ...
                                    <div class="teachers text-center">
                                        <div class="row">
                                            <div class="col-md-4 col-sm-6">
                                                <div class="thumbnail">
                                                    <div class="img-teacher"><img
                                                            alt="العلامة الحبيب عبد القادر بن أحمد بن عبد الرحمن  السقاف "
                                                            src="img/t1.jpg" /></div>
                                            ...
                                            <div class="col-md-4 col-sm-6">
                                                <div class="thumbnail">
                                                    <div class="img-teacher"><img
                                                            alt="العلامة الحبيب عمر بن محمد بن سالم بن حفيظ بن الشيخ أبوبكر بن سالم"
                                                            src="img/t2.jpg" /></div>

                                                    <div class="caption">
                                                        <h3>العلامة الحبيب عمر بن محمد بن سالم بن حفيظ بن الشيخ أبوبكر
                                                            بن سالم</h3>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4 col-sm-6">
                                                <div class="thumbnail">
                                                    <div class="img-teacher"><img
                                                            alt="العلامة الدكتور على جمعة مفتي الديار المصرية "
                                                            src="img/t6.jpg" /></div>
                                            ...
                                            <div class="col-md-4 col-sm-6">
                                                <div class="thumbnail">
                                                    <div class="img-teacher"><img
                                                            alt="الشيخ المربي : السيّد محجوب أبوفارس الصفراني "
                                                            src="img/t3.jpg" /></div>
                                            ...
                                            <div class="col-md-4 col-sm-6">
                                                <div class="thumbnail">
                                                    <div class="img-teacher"><img
                                                            alt="العلامة السيد الشيخ محمود افندي المجددي الخالدي النقشبندي "
                                                            src="img/t4.jpg" /></div>

                                                    <div class="caption">
                                                        <h3>العلامة السيد الشيخ محمود افندي المجددي الخالدي النقشبندي
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4 col-sm-6">
                                                <div class="thumbnail">
                                                    <div class="img-teacher"><img
                                                            alt="العلامة الشيخ ابراهيم آل خليفة الاحسائي"
                                                            src="img/t7.jpg" /></div>
                                            ...
                                            <div class="col-md-4 col-sm-6">
                                                <div class="thumbnail">
                                                    <div class="img-teacher"><img
                                                            alt="الحبيب أبوبكر بن علي العدني المشهور "
                                                            src="img/t8.jpg" /></div>
                                            ...
                                            <div class="col-md-4 col-sm-6">
                                                <div class="thumbnail">
                                                    <div class="img-teacher"><img
                                                            alt="الحبيب علي زين العابدين بن عبد الرحمن الجفري "
                                                            src="img/t5.jpg" /></div>
                                            ...
                                            <div class="col-md-4 col-sm-6">
                                                <div class="thumbnail">
                                                    <div class="img-teacher"><img
                                                            alt="الحبيب محمد بن عبد الرحمن السقاف " src="img/t9.jpg" />
                                                    </div>
